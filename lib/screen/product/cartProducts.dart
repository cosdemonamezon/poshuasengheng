...
class _CartProductsState extends State<CartProducts> {
  ...
  double sumQty(List<Product> productQty) => productQty.fold(0, (previousValue, element) => previousValue + double.parse(element.qty.toString()));
  double sumQtyPack(List<Product> productQtyPack) => productQtyPack.fold(0, (previousValue, element) => previousValue + double.parse(element.qtyPack.toString()));
  double sumPrice(List<Product> productPrice) => productPrice.fold(0, (previousValue, element) => previousValue + newtotal(element));
                                              ...
                                              Row(
                                                children: [
                                                    ...
                                                    onTap: () {
                                                      setState(() {
                                                        if (_finalListProducts[index].qty! > 1) {
                                                          _finalListProducts[index].qty = _finalListProducts[index].qty! - 1;
                                                        } else {}
                                                      });
                                                    },
                                                    child: Container(
                                                      decoration: BoxDecoration(border: Border.all(color: kDisableColor)),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                      decoration: BoxDecoration(border: Border.all(color: kDisableColor), color: Colors.white),
                                                    ...
                                                    onTap: () {
                                                      setState(() {
                                                        if (_finalListProducts[index].qtyPack! > 1) {
                                                          _finalListProducts[index].qtyPack = _finalListProducts[index].qtyPack! - 1;
                                                        } else {}
                                                      });
                                                    },
                                                    child: Container(
                                          ...
                                          (index) => Column(
                                                children: [
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: [
                                                      Text('${groupProduct[index].key}  ${sumQty(groupProduct[index].value)} x ${int.parse(sumQtyPack(groupProduct[index].value).round().toString())}'),
                                                    ],
                                                  ),
                                                  Column(
                                                    children: List.generate(
                                                          ...
                                                          Expanded(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  enable == false
                                                                  ?Text('')
                                                                  :Text('${currencyFormat.format(newtotal(groupProduct[index].value[index2]))}'),
                                                                ],
                                                              )),
                                                        ],
                                                      ),
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      enable == false
                                                      ?Text('')
                                                      :Text('รวม ${currencyFormat.format(sumPrice(groupProduct[index].value))}'),
